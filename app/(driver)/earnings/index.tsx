 ...
 * Dedicated financial dashboard for earnings, payslips, cash advance, and fuel
 */
...
export default function DriverEarningsScreen() {
  ...
  const earningActions = [
    {
      title: 'Payslips',
      description: 'View and download salary breakdown & incentives',
    ...
    {
      title: 'Cash Advance',
      description: 'Request or check cash advance approval status',
      icon: 'cash-multiple',
      iconColor: '#F59E0B',
    ...
    {
      title: 'Fuel & Receipts',
      description: 'Record fuel purchases, mileage, and receipts',
    ...
    {
      title: 'Trip History',
      description: 'View past completed trips and financial records',
      icon: 'history',
      iconColor: '#38BDF8',
    ...
    >
      ...
      <Card style={styles.heroCard}>
        <View style={styles.heroHeader}>
          <Text style={styles.heroSub}>ESTIMATED EARNINGS THIS MONTH</Text>
        ...
        <View style={styles.metricsRow}>
          ...
          <View style={styles.metricItem}>
            <Text style={[styles.metricValue, { color: COLORS.warning }]}>₱2,500</Text>
            <Text style={styles.metricLabel}>Cash Advance</Text>
          </View>
          <View style={styles.verticalDivider} />
          <View style={styles.metricItem}>
            <Text style={[styles.metricValue, { color: COLORS.success }]}>₱1,200</Text>
